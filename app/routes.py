"""HTTP routes for coverage-verification-service.

Generic CRUD over the `coverage_verification` table. Every mutating endpoint publishes a
...
TABLE = "coverage_verification"
RESOURCE = "coverage_verification"
CREATED_EVENT = ""
UPDATED_EVENT = ""
